...
```mermaid
flowchart LR
    A["Zatvorena predaja<br/>17.7. + 28.7.2026."] --> B["Administrativna provjera<br/>formalne ispravnosti"]
    B --> C["Rad ocjenjivačkog suda<br/>(u tijeku, kolovoz 2026.)"]
    C --> D["Odluka OS-a<br/>+ Zapisnik s obrazloženjima"]
    D --> E["Objava rezultata<br/>+ otvaranje šifri / autorstava"]
    E --> F["Javno predstavljanje i izložba<br/>≥ 15.9.2026."]
    E --> G["Obavijest o ishodu<br/>na EOJN / TED"]
    F --> H["Ugovaranje idejnog, glavnog<br/>i izvedbenog projekta<br/>s 1. nagradom"]
```
