...
const MUTANTS = [
  ...
  ["M06", "S3", "nema pravila UseSuccessor (A-01)", "if (b.revision == 0 && successor != address(0)) revert UseSuccessor(successor);", ""],
  ...
  ["M12", "S3", "preseljen listić se smije mijenjati", "if (b.migrated) revert AlreadyMigrated();\n        // Nakon", "// Nakon"],
